[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=0A00F7&width=435&lines=Je+m'appelle+Jean+Marie+RABEMANALINA;Je+suis+un+D%C3%A9veloppeur+Web+...;Web+Mobile+avec+Afpar+R%C3%A9union++2019;J'apprend+React.js+Pour+Front-end;Avec+OpenClassRooms+en+2022)](https://git.io/typing-svg)
...
- [x] :one::two: [SportSee - Développez un tableau de bord d'analytics avec React](https://github.com/vianey-jean/sportsee_jean_rabemanalina): Début du code :heavy_check_mark: :+1::hourglass:  
