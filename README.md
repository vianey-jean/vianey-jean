...
- [x] :one::two: [SportSee - Développez un tableau de bord d'analytics avec React](https:///vianey-jean.github.io/sportsee_jean_rabemanalina/): En préparation du soutenance :heavy_check_mark: :+1::hourglass:  
- [x] :one::three: Remede Agency - Utilisez une API pour un compte utilisateur bancaire avec React:Prise en main le projet :heavy_check_mark: :+1::hourglass: 
